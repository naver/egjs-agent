# How to contribute to egjs-agent
egjs-agent is opened to everyone and we're welcoming for any kind of contribution.
We believe that our project can grow with your interests helping others' necessities.

## Style Guide

egjs-agent has several style guidelines to follow.
...
egjs-agent use commit logs in many different purposes (like creating CHANGELOG, ease history searching, etc.).
...
1. Fork `egjs-agent` on your repository
...
## License
By contributing to egjs-agent, you're agreeing that your contributions will be licensed under its [MIT](https://opensource.org/licenses/MIT) license.
